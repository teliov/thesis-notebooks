...
def train_nb(data_file, symptoms_db_json, conditions_db_json, output_dir):
    ...
    precision_scorer_unweighted = make_scorer(precision_score, average='macro')
    precision_scorer_weighted = make_scorer(precision_score, average='weighted')
    roc_auc_scorer_unweighted = make_scorer(roc_auc_score, average='macro')
    roc_auc_scorer_weighted = make_scorer(roc_auc_score, average='weighted')
