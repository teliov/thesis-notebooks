...
\title[An Update]{Differential Diagnosis: Early Steps} % The short title appears at the bottom of every slide, the full title is only on the title page
...
{
Delft Technical University \\ % Your institution for the title page
\medskip
...
%------------------------------------------------
\section{Gathering Data} % Sections can be created in order to organize your presentation into discrete blocks, all sections and subsections are automatically printed in the table of contents as an overview of the talk
%------------------------------------------------
...
\subsection{Synthea} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
\begin{frame}
